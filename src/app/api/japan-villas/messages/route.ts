...
const MOCK_MESSAGES = [
  {
    ...
    suggestedReply: "田中様、お疲れ様です。15:00のアーリーチェックインは可能です。清掃が14:30頃に完了予定ですので、15:00にお越しください。鍵はキーボックス（コード4829）からお取りいただけます。ご到着をお待ちしております！",
  },
  {
    id: "msg-002",
  ...
  },
  {
    ...
    suggestedReply: "Hi Michael! The WiFi information for your cabin is: Network: \"NojiriLake-1\" Password: \"lakeview123\" You'll find this network listed on your device. If you have any trouble connecting, please let me know! Enjoy your stay at The Lake Side INN. 🏞️",
  },
  {
    id: "msg-004",
    guestName: "佐藤美咲",
